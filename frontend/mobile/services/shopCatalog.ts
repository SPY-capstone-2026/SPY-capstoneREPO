...
export const REMOVED_SHOP_ITEM_NAMES = new Set([
  '동그란 안경',
]);

export function isVisibleShopItemName(name: string | null | undefined) {
  return Boolean(name && !REMOVED_SHOP_ITEM_NAMES.has(name));
}
...
export const SHOP_ITEM_ASSETS: Record<string, ImageSourcePropType> = {
  ...
  '체크 스카프': require('@/assets/shop/accessory_scarf.png'),
  '별 목걸이': require('@/assets/shop/accessory_star_necklace.png'),
  '토끼 머리띠': require('@/assets/shop/accessory_bunny_headband.png'),
  ...
  '도트 벽지': require('@/assets/shop/wallpaper_dots.png'),
  '구름 벽지': require('@/assets/shop/wallpaper_cloud.png'),
  ...
  '체커 바닥': require('@/assets/shop/flooring_checker.png'),
  ...
  '낮은 테이블': require('@/assets/shop/furniture_low_table.png'),
  '쿠션 의자': require('@/assets/shop/furniture_cushion_chair.png'),
  ...
  '별 조명': require('@/assets/shop/decor_star_lamp.png'),
  '책 더미': require('@/assets/shop/decor_books.png'),
...
export const ITEM_EFFECTS: Record<string, string> = {
  ...
  '체크 스카프': '목 아래에 포근한 체크 스카프를 둘러요.',
  '별 목걸이': '가슴 쪽에 작은 별 목걸이를 달아줘요.',
  '토끼 머리띠': '귀 위에 귀여운 토끼 머리띠를 올려요.',
  ...
  '낮은 테이블': 'Moni가 쉬기 좋은 낮은 테이블을 놓아요.',
  '쿠션 의자': '폭신한 쿠션 의자를 방에 배치해요.',
  ...
  '별 조명': '방에 은은한 별 모양 조명을 놓아요.',
  '책 더미': '작은 책 더미를 소품으로 배치해요.',
